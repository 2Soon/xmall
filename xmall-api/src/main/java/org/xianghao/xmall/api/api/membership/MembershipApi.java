package org.xianghao.xmall.api.api.membership;
...
public interface MembershipApi {
	...
	Boolean informPayOrderEvent(@PathVariable("userAccountId")Long userAccountId, 
	...
	Boolean informFinishReturnGoodsEvent(@PathVariable("userAccountId")Long userAccountId, 
			@RequestParam("totalOrderAmount") Double totalOrderAmount);
	...
	Boolean informPublishCommentEvent(@PathVariable("userAccountId") Long userAccountId, 
	...
	Boolean informRemoveCommentEvent(@PathVariable("userAccountId") Long userAccountId, 
			@RequestParam("showPictures") Boolean showPictures);
